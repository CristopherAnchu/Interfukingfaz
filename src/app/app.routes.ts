...
import { ProjectVersionComponent } from './componentes/project-version/project-version.component';
...
export const routes: Routes = [
    ...
    {path: "project-version/:id", component: ProjectVersionComponent, canActivate:[loginGuard]},
